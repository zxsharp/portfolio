...
export const Tabs: React.FC<TabsProps> = ({
  ...
  buttonClassName = "flex items-center justify-center rounded-full h-fit px-3 py-2 text-sm sm:text-md md:text-lg text-foreground font-medium tracking-widest uppercase transform will-change-transform border-2 border-transparent hover:border-secondary transition-colors duration-400 ease-out",
